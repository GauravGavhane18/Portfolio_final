    ...
    <div id='goals' className="relative z-50 my-12 lg:my-24">
      ...
      <div className="pt-24">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {personalData.areasOfInterest.map((interest) => (
...
const InterestCard = ({ interest }) => {
  return (
    <div className="bg-gradient-to-r from-[#0d1224] to-[#0a0e27] rounded-lg border border-[#1b2c68a0] p-6 hover:border-[#464c6a] transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10">
